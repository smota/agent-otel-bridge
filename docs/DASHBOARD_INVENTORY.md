...
|---|---|---|---|
| **AI Fleet Executive & AI Governance** | `01a091ef-5319-7646-8fdd-efabd14f5708` | VP of Eng, Head of AI Platform | Fleet Quota Headroom (`agent.fleet.bottleneck_ratio`), Active Agent Sessions, Execution Mode (`iterativo` vs `automacao`), Ecosystem Share, Terminal Environments, Developer Attribution (`user.email`). |
