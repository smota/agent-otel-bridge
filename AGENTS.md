...
* **`main`**: Production trunk. Protected branch. Releases are tagged from `main` (`v0.1.0`, `v0.2.0`, `v0.3.0`, `v0.4.0`, `v0.5.0`). Direct pushes to `main` are restricted to maintainers for release merges.
