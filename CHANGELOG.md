...
* 📚 **Authoritative Architectural Guides**: Published the definitive decision guide ([`docs/WHY_AGENT_OTEL_BRIDGE.md`](docs/WHY_AGENT_OTEL_BRIDGE.md)) and an updated system limitations and mitigations catalog ([`docs/LIMITATIONS.md`](docs/LIMITATIONS.md)).
...
* **[`docs/WHY_AGENT_OTEL_BRIDGE.md`](docs/WHY_AGENT_OTEL_BRIDGE.md)**: Comprehensive architectural comparison between `agent-otel-bridge` and native AI harness telemetry, evaluating hot-path latency, zero prompt pollution, multi-agent correlation, and vendor independence.
* **[`docs/LIMITATIONS.md`](docs/LIMITATIONS.md)**: Updated engineering limitations catalog, formally retiring the 15-platform wire limit and detailing mitigations for workspace shadowing, watchdog span drops, and tokenizer heuristics.
* **[`docs/CLIENTS.md`](docs/CLIENTS.md)**: Updated with the complete step-by-step blueprint for integrating new harnesses (e.g. Hermes).
...
- **Developer Attribution**: Harvest developer identity from Git config with machine fallback.
